...
RESOURCES += src/qt/blibrary.qrc src/qt/blibrary_locale.qrc

TRANSLATIONS += src/qt/locale/blibrary_bg.ts \
                src/qt/locale/blibrary_de.ts \
                src/qt/locale/blibrary_en.ts \
                src/qt/locale/blibrary_es.ts \
                src/qt/locale/blibrary_fi.ts \
                src/qt/locale/blibrary_fr.ts \
                src/qt/locale/blibrary_it.ts \
                src/qt/locale/blibrary_ja.ts \
                src/qt/locale/blibrary_pl.ts \
                src/qt/locale/blibrary_pt.ts \
                src/qt/locale/blibrary_ru.ts \
                src/qt/locale/blibrary_sk.ts \
                src/qt/locale/blibrary_sv.ts \
                src/qt/locale/blibrary_vi.ts \
                src/qt/locale/blibrary_zh_CN.ts \
                src/qt/locale/blibrary_zh_TW.ts
