/* src/config/wildnode-config.h.  Generated from wildnode-config.h.in by configure.  */
/* src/config/wildnode-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef wildnode_CONFIG_H

#define wildnode_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.blockchain-library.info"

/* Define to the full name of this package. */
#define PACKAGE_NAME "wildnode Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "wildnode Core 1.1.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "wildnode"
