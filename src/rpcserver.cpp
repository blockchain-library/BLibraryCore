...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop blibrary server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "blibrary server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* blibrary features */
        {"blibrary", "masternode", &masternode, true, true, false},
        {"blibrary", "listmasternodes", &listmasternodes, true, true, false},
        {"blibrary", "getmasternodecount", &getmasternodecount, true, true, false},
        {"blibrary", "masternodeconnect", &masternodeconnect, true, true, false},
        {"blibrary", "masternodecurrent", &masternodecurrent, true, true, false},
        {"blibrary", "masternodedebug", &masternodedebug, true, true, false},
        {"blibrary", "startmasternode", &startmasternode, true, true, false},
        {"blibrary", "createmasternodekey", &createmasternodekey, true, true, false},
        {"blibrary", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"blibrary", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"blibrary", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"blibrary", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"blibrary", "getmasternodescores", &getmasternodescores, true, true, false},
        {"blibrary", "mnbudget", &mnbudget, true, true, false},
        {"blibrary", "preparebudget", &preparebudget, true, true, false},
        {"blibrary", "submitbudget", &submitbudget, true, true, false},
        {"blibrary", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"blibrary", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"blibrary", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"blibrary", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"blibrary", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"blibrary", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"blibrary", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"blibrary", "checkbudgets", &checkbudgets, true, true, false},
        {"blibrary", "mnsync", &mnsync, true, true, false},
        {"blibrary", "spork", &spork, true, true, false},
        {"blibrary", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"blibrary", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use blibraryd, or the -server option to blibrary-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> blibrary-cli " + methodname + " " + args + "\n";
}
