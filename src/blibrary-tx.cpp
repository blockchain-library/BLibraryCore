...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("blibrary Core blibrary-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  blibrary-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded blibrary transaction") + "\n" +
                               "  blibrary-tx [options] -create [commands]   " + _("Create hex-encoded blibrary transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded blibrary transaction
