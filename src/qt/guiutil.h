...
/** Utility functions used by the blibrary Qt UI.
 */
namespace GUIUtil
{
...
// Render blibrary addresses in monospace font
...
// Parse "blibrary:" URI into recipient object, return true on successful parsing
