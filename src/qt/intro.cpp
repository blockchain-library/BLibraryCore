...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("blibrary Core"),
     ...
     * override -datadir in the blibrary.conf file in the default data directory
     * (to be consistent with blibraryd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
