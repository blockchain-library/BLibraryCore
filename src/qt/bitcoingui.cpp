                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("blibrary Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a blibrary address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and blibrary: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zblib"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About blibrary Core"), this);
    aboutAction->setStatusTip(tr("Show information about blibrary Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for blibrary"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your blibrary addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified blibrary addresses"));
    ...
    openAction->setStatusTip(tr("Open a blibrary: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the blibrary Core help message to get a list with possible blibrary command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("blibrary Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to blibrary network", "", count));
}
...
{
    QString strTitle = tr("blibrary Core"); // default title
...
/** Creates context menu, its actions, and blibrarys up all the relevant signals for mouse events. */
