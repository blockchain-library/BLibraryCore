...
public:
    ...
    void setZblibraryControlLabels(int64_t nAmount, int nQuantity);
...
//    void coinControlClipboardChange();
    ...
    void on_pushButtonMintzblib_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzblib_clicked();
    void on_pushButtonZblibraryControl_clicked();
