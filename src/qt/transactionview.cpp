                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received blibrary from zblib"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zblib"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zblib));
