Contributing to blibrary Core
============================

The blibrary Core project operates an open contributor model where anyone is
...
The following applies to code changes to the blibrary Core project, and is not to be
confused with overall blibrary Network Protocol consensus changes.

Whether a pull request is merged into blibrary Core rests with the project merge
...
Patches that change blibrary consensus rules are considerably more involved than
...
Where a patch set proposes to change the blibrary consensus, it must have been
...
The project leader is the release manager for each blibrary Core release.
