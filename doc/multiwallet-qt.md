...
In order to support loading of multiple wallets in blibrary-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is blibrary.cpp.
...
Changes to blibrary.cpp
----------------------
blibrary.cpp is the entry point into blibrary-qt, and as such, will require some minor modifications to provide hooks for
